<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/MP.Master" AutoEventWireup="true" CodeBehind="Registrarse.aspx.cs" Inherits="Vinedo.Paginas.Registrarse" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
     <div class="container box">
        ...
        <div class="field">
         ...
         <div class="field">
            <label class="label">Id_Rol</label>
            <div class="control">
                <asp:TextBox runat="server" ID="Id_Rol" CssClass="input" type="password" placeholder="*****"></asp:TextBox>
            </div>
        </div>
